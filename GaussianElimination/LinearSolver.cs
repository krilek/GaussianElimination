...
namespace GaussianElimination
{
    ...
    {
        private static void CleanMatrix<T>(MojaMacierz<T> matrix, MojaMacierz<T> vector, int row) where T : Value<T>, new()
        {
        ...
        private static MojaMacierz<T> CountBackwardResult<T>(MojaMacierz<T> matrix, MojaMacierz<T> vector) where T : Value<T>, new()
        {
        ...
        public static MojaMacierz<T> Gauss<T>(MojaMacierz<T> matrix, MojaMacierz<T> vector) where T : Value<T>, new()
        {
